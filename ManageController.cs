...
#region Helpers
        ...
        public FileContentResult Photo(string userId)
        {
            ...
            {
                string fileName = HttpContext.Server.MapPath(@"~/content/images/defaultProfilePic.png");
                ...
                //return File(Server.MapPath("/content/images/defaultProfilePic.png"), "image/jpeg");
                // return HttpContext.Server.MapPath("/UploadedFiles");
            }
            else
            {
        ...
        {
            ViewBag.Message = "Update your profile image";
            return View();
        }
